/****************************************************************************
 * 		Посроение векторов на основе структуры кортеж						*
 * 		Вычисление длины вектора, нормализация, скалярное и векторное		*
 * 		произведение, нахождения отраженного вектора от вектора нормали		*
 * 		объекта																*
 ****************************************************************************/
//
